...
def viewtransaction(request):
    u = request.user
    transactions = Transaction.objects.filter(user=u).order_by('date')  # Assuming transactions are ordered by date
    ...
    for transaction in transactions:
        ...
        transaction.save()  # Save the updated balance to the transaction

    return render(request, "viewtransaction.html", {"transactions": transactions})
